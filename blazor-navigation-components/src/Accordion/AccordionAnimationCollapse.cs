...
{
    /// <summary>
    /// A class that represents the animation to appear while collapsing the <see cref="AccordionItem"/>.
    /// </summary>
    /// <remarks>
    ...
    /// ]]></code>
    /// </example>
    public partial class AccordionAnimationCollapse : SfOwningComponentBase
    {
        [CascadingParameter]
        ...
        /// </summary> 
        /// <value> 
        /// One of the <see cref="AnimationEffect"/> enumeration. The default value is <see cref="AnimationEffect.SlideUp"/> 
        /// </value> 
        /// <remarks>
