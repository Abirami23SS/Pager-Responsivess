...
namespace Syncfusion.Blazor.Navigations
{
    ...
    /// </summary>
    /// <remarks>
    /// You can apply the animation effect and transform duration while switching to next <see cref="TabItem"/> by specifying value to corresponding property.
    /// </remarks>
    /// <example>
    /// <code><![CDATA[
    /// <SfTab>
    ...
    /// ]]></code>
    /// </example>
    public partial class TabAnimationNext : SfOwningComponentBase
    {
        ...
        /// </summary>
        /// <value>
        /// If we set the easing value, then the specified easing effect is applied when switching to next tab otherwise the default easing value <c>ease</c> is set.
        /// </value>
        /// <remarks>
        ...
        /// </summary> 
        /// <value> 
        /// One of the <see cref="AnimationEffect"/> enumeration. The default value is <see cref="AnimationEffect.SlideRightIn"/> 
        /// </value> 
        /// <remarks>
