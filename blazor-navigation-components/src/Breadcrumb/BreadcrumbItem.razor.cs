...
namespace Syncfusion.Blazor.Navigations
{
    ...
    /// ]]></code>
    /// </example>
    public partial class BreadcrumbItem: SfOwningComponentBase

    {
        ...
        public Dictionary<string, object> HtmlAttributes { get { return itemHtmlAttributes; } set { itemHtmlAttributes = SfBaseUtils.SanitizeHtmlAttributes(value); } }
