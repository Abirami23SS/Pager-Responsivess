...
namespace Syncfusion.Blazor.Navigations
{
    public partial class SfToolbar : SfBaseComponent
    {
        ...
        public async Task RemoveItems(int index)
        {
            ...
            {
                if (!Items[index].ItemFromTag)
                {
                    ItemModel item = ToolbarItems.Find(x => x.Id == Items[index].Id);
                ...
                await InvokeMethod("sfBlazor.Toolbar.hideItem", new object[] { dataId, Items, index }).ConfigureAwait(true);
            }
        }
        ...
        {
            await InvokeMethod("sfBlazor.Toolbar.disable", new object[] { dataId, disable }).ConfigureAwait(true);
        }
        ...
        {
            await InvokeMethod("sfBlazor.Toolbar.refreshOverflow", new object[] { dataId }).ConfigureAwait(true);
        }
        ...
        {
            await InvokeMethod("sfBlazor.Toolbar.refresh", new object[] { dataId, GetInstance() }).ConfigureAwait(true);
        }
