(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["_content/Syncfusion.Blazor.Navigations/scripts/sf-accordion"],{
...
window.sfBlazor.Accordion = function () {
  ...
  var SfAccordion = /** @class */function () {
    ...
    SfAccordion.prototype.expandProgress = function (progress, icon, trgt, trgtItemEle, eventArgs) {
      ...
      if (progress === 'end') {
        ...
        sf.base.attributes(trgtItemEle.firstElementChild, {
          'aria-expanded': 'true'
        });
  ...
  var Accordion = {
    ...
    expandingItem: function expandingItem(dataId, args) {
      var instance = window.sfBlazor.getCompInstance(dataId);
      if (instance.element) {
        instance.expandingItem(args);
      }
    },
    collapsingItem: function collapsingItem(dataId, args) {
      var instance = window.sfBlazor.getCompInstance(dataId);
      if (instance.element) {
    ...
    setExpandModeAndRTL: function setExpandModeAndRTL(dataId, enableRtl, expandMode, isRtlChanged, isExpandModeChanged) {
      var instance = window.sfBlazor.getCompInstance(dataId);
      if (instance.element) {
        if (isRtlChanged) {
          if (enableRtl) {
    ...
    itemChanged: function itemChanged(dataId) {
      var instance = window.sfBlazor.getCompInstance(dataId);
      if (instance.element) {
        instance.wireFocusEvents();
      }
    },
    afterContentRender: function afterContentRender(dataId, targetEle, animation) {
      var instance = window.sfBlazor.getCompInstance(dataId);
      if (instance.element) {
    ...
    itemExpandedOrCollapsed: function itemExpandedOrCollapsed(dataId, args) {
      var instance = window.sfBlazor.getCompInstance(dataId);
      if (instance.element) {
...
}]);(async()=>{await import(`${document.baseURI}_content/Syncfusion.Blazor.Core/scripts/syncfusion-blazor-base.min.js`).then(()=>{sfBlazor.loadDependencies('sfaccordion');})})();