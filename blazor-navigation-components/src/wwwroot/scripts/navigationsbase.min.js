(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["_content/Syncfusion.Blazor.Navigations/scripts/navigationsbase"],{
  ...
  var HScroll = /** @class */function (_super) {
    ...
    HScroll.prototype.createOverlay = function (element) {
      ...
      var rightOverlayEle = this.createElement('div', {
        className: CLS_OVERLAY$1 + ' ' + CLS_RIGHTOVERLAY
      });
      ...
      var navItem = this.createElement('div', {
        className: CLS_NAVRIGHTARROW + ' ' + CLS_NAVARROW$1 + ' e-icons'
      });
      rightEle.appendChild(navItem);
      var leftEle = this.createElement('div', {
        className: CLS_OVERLAY$1 + ' ' + CLS_LEFTOVERLAY
      });
      if (this.ieCheck) {
    ...
    HScroll.prototype.createNavIcon = function (element) {
      ...
      var navEle = this.createElement('div', {
        className: clsLeft + ' ' + CLS_DISABLE$1,
        attrs: leftAttributes
      });
      navEle.setAttribute('aria-disabled', 'true');
      var navLeftItem = this.createElement('div', {
        className: CLS_NAVLEFTARROW + ' ' + CLS_NAVARROW$1 + ' e-icons'
      });
    ...
    HScroll.prototype.frameScrollRequest = function (scrollVal, action, isContinuous) {
      ...
      var _animate2 = function animate() {
        ...
        if (scrollValue < step) {
          ...
          window.requestAnimationFrame(_animate2);
        }
      };
      _animate2();
    };
    ...
    VScroll.prototype.swipeHandler = function (e) {
      ...
      var _animate3 = function animate() {
        ...
        if (step <= 0) {
          ...
          start -= 0.02;
          window.requestAnimationFrame(_animate3);
        }
      };
      _animate3();
    };
    ...
    VScroll.prototype.frameScrollRequest = function (scrollValue, action, isContinuous) {
      ...
      var _animate4 = function animate() {
        if (scrollValue < step) {
          ...
          scrollValue -= step;
          window.requestAnimationFrame(_animate4);
        }
      };
      _animate4();
    };
...
}]);(async()=>{await import(`${document.baseURI}_content/Syncfusion.Blazor.Core/scripts/syncfusion-blazor-base.min.js`).then(()=>{})})();