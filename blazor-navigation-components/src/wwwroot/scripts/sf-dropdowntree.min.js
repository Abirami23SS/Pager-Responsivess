(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["_content/Syncfusion.Blazor.Navigations/scripts/sf-dropdowntree"],{
...
window.sfBlazor.DropDownTree = function () {
  ...
  var SfDropDownTree = /** @class */function () {
            ...
            if (!sf.base.isNullOrUndefined(this.valueTemplateContainer)) {
              ...
              for (var i = 0; i < chips.length; i++) {
                ...
                if (templateWrapperLength + downIconWidth + clearIconWidth > overAllContainer) {
                  ...
                  templateWrapperLength = this.overFlowWrapper.offsetWidth;
                  while (templateWrapperLength + remainSize + downIconWidth + clearIconWidth >= overAllContainer && wrapperleng !== 0 && this.overFlowWrapper.firstChild) {
    ...
    SfDropDownTree.prototype.updateRemainTemplate = function (remainElement, remaining, remainContent, totalContent) {
      ...
      remainElement.innerText = this.overFlowWrapper.firstChild && (this.overFlowWrapper.firstChild.nodeType === 3 || this.options.mode === 'Box') || !sf.base.isNullOrUndefined(this.valueTemplateContainer) ? remainContent.replace('${count}', remaining.toString()) : totalContent.replace('${count}', remaining.toString());
    ...
    SfDropDownTree.prototype.onDocumentClick = function (e) {
      ...
      if (this.isPopupOpen && (!sf.base.isNullOrUndefined(this.inputWrapper) && this.inputWrapper.contains(target) || isTree || isScroller || isHeader || isFooter) || (this.options.allowMultiSelection || this.options.showCheckBox) && (this.isPopupOpen && target.classList.contains(CHIP_CLOSE) || this.isPopupOpen && (target.classList.contains(CHECKALLPARENT) || target.classList.contains(ALLTEXT) || target.classList.contains(CHECKBOXFRAME) || target.classList.contains(CHECKBOXLABEL)))) {
        e.preventDefault();
    ...
    SfDropDownTree.prototype.setChipWrapperClass = function () {
      ...
      if (!this.options.textWrap && this.inputWrapper.offsetWidth !== 0 && (this.options.allowMultiSelection || this.options.showCheckBox)) {
        this.updateView();
  ...
  var DropDownTree = {
    initialize: function initialize(dataId, containerElement, dotnetRef, options, uniqueID) {
      var instance = new SfDropDownTree(dataId, containerElement, dotnetRef, options, uniqueID);
      if (!sf.base.isNullOrUndefined(instance)) {
        instance.initialize();
      }
    },
    showPopup: function showPopup(dataId, value, args, popupContentElement) {
      ...
      if (!sf.base.isNullOrUndefined(instance)) {
        ...
        if (instance.chipWrapper && instance.options.mode !== 'Delimiter' && instance.options.value && instance.options.value.length !== 0) {
          ...
          if (!sf.base.isNullOrUndefined(instance.overFlowWrapper) && !sf.base.isNullOrUndefined(instance.valueTemplateContainer) && !instance.options.textWrap) {
    ...
    updateValue: function updateValue(dataId, value) {
      var instance = window.sfBlazor.getCompInstance(dataId);
      if (!sf.base.isNullOrUndefined(instance)) {
...
}]);(async()=>{await import(`${document.baseURI}_content/Syncfusion.Blazor.Core/scripts/syncfusion-blazor-base.min.js`).then(()=>{sfBlazor.loadDependencies('sfdropdowntree');})})();