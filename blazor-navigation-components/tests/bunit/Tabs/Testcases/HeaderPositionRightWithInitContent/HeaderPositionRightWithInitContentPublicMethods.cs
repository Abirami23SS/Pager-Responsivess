...
using Syncfusion.Blazor.Tests.Tabs.Samples.HeaderPositionRightWithInitContent.PublicMethods;
using System.Threading.Tasks;
using Xunit;

namespace Syncfusion.Blazor.Tests.Tabs
{
    public class HeaderPositionRightWithInitContentPublicMethods : BunitTestContext
    {
