...
using Syncfusion.Blazor.Tests.Tabs.Samples.HeaderPositionRightWithInitContent.TabItem;
using System;
using System.Linq;
...
{
    public class HeaderPositionRightWithInitContentTabItem : BunitTestContext
    {
