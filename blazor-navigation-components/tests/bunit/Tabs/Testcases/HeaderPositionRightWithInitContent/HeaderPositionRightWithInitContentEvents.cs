...
using Syncfusion.Blazor.Tests.Tabs.Samples.HeaderPositionRightWithInitContent.Events;
using System.Threading.Tasks;
using Xunit;

namespace Syncfusion.Blazor.Tests.Tabs
{
    public class HeaderPositionRightWithInitContentEvents : BunitTestContext
    {
