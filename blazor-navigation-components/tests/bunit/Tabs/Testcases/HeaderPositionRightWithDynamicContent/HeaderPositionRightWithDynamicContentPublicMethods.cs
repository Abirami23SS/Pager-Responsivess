...
using Syncfusion.Blazor.Tests.Tabs.Samples.HeaderPositionRightWithDynamicContent.PublicMethods;
using System.Threading.Tasks;
using Xunit;

namespace Syncfusion.Blazor.Tests.Tabs
{
    public class HeaderPositionRightWithDynamicContentPublicMethods : BunitTestContext
    {
