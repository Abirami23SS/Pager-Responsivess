...
using Syncfusion.Blazor.Tests.Tabs.Samples.HeaderPositionRightWithDynamicContent.TabItem;
using System;
using System.Linq;
...
{
    public class HeaderPositionRightWithDynamicContentTabItem : BunitTestContext
    {
