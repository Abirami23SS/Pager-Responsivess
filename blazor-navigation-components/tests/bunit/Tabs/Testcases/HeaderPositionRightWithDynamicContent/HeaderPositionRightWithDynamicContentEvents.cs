...
using Syncfusion.Blazor.Tests.Tabs.Samples.HeaderPositionRightWithDynamicContent.Events;
using System.Threading.Tasks;
using Xunit;

namespace Syncfusion.Blazor.Tests.Tabs
{
    public class HeaderPositionRightWithDynamicContentEvents : BunitTestContext
    {
