...
using Syncfusion.Blazor.Tests.Tabs.Samples.MultiRowModeHeaderPositionLeftWithInitContent.Default;
using System;
using System.Linq;
...
{
    public class MultiRowModeHeaderPositionLeftWithInitContentDefault : BunitTestContext
    {
        ...
        {
            var tab = RenderComponent<SfTab>(options => options.Add(content => content.OverflowMode, Syncfusion.Blazor.Navigations.OverflowMode.MultiRow).Add(content => content.HeaderPlacement, HeaderPosition.Left).Add(content => content.LoadOn, ContentLoad.Init));
            ...
            Assert.Equal(HeaderPosition.Left, tab.Instance.HeaderPlacement);
            ...
            Assert.Equal(ContentLoad.Init, tab.Instance.LoadOn);
        ...
        public async Task Default()
        {
            ...
            Assert.Contains(HelperCls.VerticalLeft, tabHtml.ClassName);
            ...
            Assert.Contains(HelperCls.VerticalLeft, tabHeaderHtml.ClassName);
        ...
        {
            var tab = RenderComponent<SfTab>(options => options.Add(content => content.OverflowMode, Syncfusion.Blazor.Navigations.OverflowMode.MultiRow).Add(content => content.HeaderPlacement, HeaderPosition.Left).Add(p => p.Height, "260px").Add(content => content.LoadOn, ContentLoad.Init));
            await Task.Delay(100);
            var tabEle = tab.Find("." + HelperCls.Tab);
            Assert.NotNull(tabEle);
            Assert.Contains(HelperCls.VerticalTab, tabEle.ClassName);
            Assert.Contains(HelperCls.VerticalLeft, tabEle.ClassName);
        ...
        {
            var tab = RenderComponent<SfTab>(options => options.Add(content => content.OverflowMode, Syncfusion.Blazor.Navigations.OverflowMode.MultiRow).Add(content => content.HeaderPlacement, HeaderPosition.Left).Add(p => p.Width, "600px").Add(content => content.LoadOn, ContentLoad.Init));
            await Task.Delay(100);
            var tabEle = tab.Find("." + HelperCls.Tab);
            Assert.NotNull(tabEle);
            Assert.Contains(HelperCls.VerticalTab, tabEle.ClassName);
        ...
        public async Task ARIAAttributes()
        {
            ...
            Assert.Equal("vertical", tab.Find("." + HelperCls.Toolbar).GetAttribute("aria-orientation"));
            ...
            Assert.Equal("tabpanel", tab.FindAll("." + HelperCls.Item)[1].GetAttribute("role"));
            Assert.Equal("tabpanel", tab.FindAll("." + HelperCls.Item)[2].GetAttribute("role"));
        }
