...
using Syncfusion.Blazor.Tests.Tabs.Samples.MultiRowModeHeaderPositionLeftWithInitContent.TabItem;
using System;
using System.Linq;
...
{
    public class MultiRowModeHeaderPositionLeftWithInitContentTabItem : BunitTestContext
    {
