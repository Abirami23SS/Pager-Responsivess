...
using Syncfusion.Blazor.Tests.Tabs.Samples.HeaderPositionBottomWithInitContent.PublicMethods;
using System.Threading.Tasks;
using Xunit;

namespace Syncfusion.Blazor.Tests.Tabs
{
    public class HeaderPositionBottomWithInitContentPublicMethods : BunitTestContext
    {
