...
using Syncfusion.Blazor.Tests.Tabs.Samples.HeaderPositionBottomWithInitContent.Events;
using System.Threading.Tasks;
using Xunit;

namespace Syncfusion.Blazor.Tests.Tabs
{
    public class HeaderPositionBottomWithInitContentEvents : BunitTestContext
    {
