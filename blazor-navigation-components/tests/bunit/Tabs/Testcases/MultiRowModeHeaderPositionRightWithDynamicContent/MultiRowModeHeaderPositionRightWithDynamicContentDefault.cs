...
using Syncfusion.Blazor.Tests.Tabs.Samples.MultiRowModeHeaderPositionRightWithDynamicContent.Default;
using System;
using System.Linq;
...
{
    public class MultiRowModeHeaderPositionRightWithDynamicContentDefault : BunitTestContext
    {
        ...
        {
            var tab = RenderComponent<SfTab>(options => options.Add(content => content.OverflowMode, Syncfusion.Blazor.Navigations.OverflowMode.MultiRow).Add(content => content.HeaderPlacement, HeaderPosition.Right));
        ...
        {
            var tab = RenderComponent<SfTab>(options => options.Add(content => content.OverflowMode, Syncfusion.Blazor.Navigations.OverflowMode.MultiRow).Add(content => content.HeaderPlacement, HeaderPosition.Right).Add(p => p.Height, "260px"));
            await Task.Delay(100);
        ...
        {
            var tab = RenderComponent<SfTab>(options => options.Add(content => content.OverflowMode, Syncfusion.Blazor.Navigations.OverflowMode.MultiRow).Add(content => content.HeaderPlacement, HeaderPosition.Right).Add(p => p.Width, "600px"));
            await Task.Delay(100);
            var tabEle = tab.Find("." + HelperCls.Tab);
            Assert.NotNull(tabEle);
            Assert.Contains(HelperCls.VerticalTab, tabEle.ClassName);
