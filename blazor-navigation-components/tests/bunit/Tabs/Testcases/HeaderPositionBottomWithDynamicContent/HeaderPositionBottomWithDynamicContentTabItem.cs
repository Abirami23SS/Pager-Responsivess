...
using Syncfusion.Blazor.Tests.Tabs.Samples.HeaderPositionBottomWithDynamicContent.TabItem;
using System;
using System.Linq;
...
{
    public class HeaderPositionBottomWithDynamicContentTabItem : BunitTestContext
    {
