...
using Syncfusion.Blazor.Tests.Tabs.Samples.MultiRowModeHeaderPositionTopWithDynamicContent.PublicMethods;
using System.Threading.Tasks;
using Xunit;

namespace Syncfusion.Blazor.Tests.Tabs
{
    public class MultiRowModeHeaderPositionTopWithDynamicContentPublicMethods : BunitTestContext
    {
