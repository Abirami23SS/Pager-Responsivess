...
using Syncfusion.Blazor.Tests.Tabs.Samples.HeaderPositionLeftWithInitContent.TabItem;
using System;
using System.Linq;
...
{
    public class HeaderPositionLeftWithInitContentTabItem : BunitTestContext
    {
