...
using Syncfusion.Blazor.Tests.Tabs.Samples.HeaderPositionLeftWithInitContent.Default;
using System;
using System.Linq;
...
{
    public class HeaderPositionLeftWithInitContentDefault : BunitTestContext
    {
        ...
        {
            var tab = RenderComponent<SfTab>(options => options.Add(content => content.HeaderPlacement, HeaderPosition.Left).Add(content => content.LoadOn, ContentLoad.Init));
        ...
        {
            var tab = RenderComponent<SfTab>(options => options.Add(content => content.HeaderPlacement, HeaderPosition.Left).Add(p => p.Height, "260px").Add(content => content.LoadOn, ContentLoad.Init));
            await Task.Delay(100);
        ...
        {
            var tab = RenderComponent<SfTab>(options => options.Add(content => content.HeaderPlacement, HeaderPosition.Left).Add(p => p.Width, "600px").Add(content => content.LoadOn, ContentLoad.Init));
            await Task.Delay(100);
            var tabEle = tab.Find("." + HelperCls.Tab);
            Assert.NotNull(tabEle);
            Assert.Contains(HelperCls.VerticalTab, tabEle.ClassName);
