...
using Syncfusion.Blazor.Tests.Tabs.Samples.MultiRowModeHeaderPositionTopWithInitContent.TabItem;
using System;
using System.Linq;
...
{
    public class MultiRowModeHeaderPositionTopWithInitContentTabItem : BunitTestContext
    {
        ...
        public async Task ForeachLoop()
        {
            ...
            var buttonElement = tab.Find("#AddButton");
            ...
            var removeButton = tab.Find("#RemoveButton");
