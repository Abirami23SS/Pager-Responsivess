...
using Syncfusion.Blazor.Tests.Tabs.Samples.MultiRowModeHeaderPositionBottomWithDynamicContent.Default;
using System;
using System.Linq;
...
{
    public class MultiRowModeHeaderPositionBottomWithDynamicContentDefault : BunitTestContext
    {
        ...
        {
            var tab = RenderComponent<SfTab>(options => options.Add(content => content.OverflowMode, Syncfusion.Blazor.Navigations.OverflowMode.MultiRow).Add(content => content.HeaderPlacement, HeaderPosition.Bottom));
        ...
        {
            var tab = RenderComponent<SfTab>(options => options.Add(content => content.OverflowMode, Syncfusion.Blazor.Navigations.OverflowMode.MultiRow).Add(content => content.HeaderPlacement, HeaderPosition.Bottom).Add(p => p.Height, "260px"));
            await Task.Delay(100);
        ...
        {
            var tab = RenderComponent<SfTab>(options => options.Add(content => content.OverflowMode, Syncfusion.Blazor.Navigations.OverflowMode.MultiRow).Add(content => content.HeaderPlacement, HeaderPosition.Bottom).Add(p => p.Width, "600px"));
            await Task.Delay(100);
            var tabEle = tab.Find("." + HelperCls.Tab);
            Assert.NotNull(tabEle);
