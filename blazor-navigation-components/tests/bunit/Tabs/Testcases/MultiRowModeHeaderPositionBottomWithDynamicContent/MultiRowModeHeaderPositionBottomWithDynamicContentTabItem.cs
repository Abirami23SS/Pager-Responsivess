...
using Syncfusion.Blazor.Tests.Tabs.Samples.MultiRowModeHeaderPositionBottomWithDynamicContent.TabItem;
using System;
using System.Linq;
...
{
    public class MultiRowModeHeaderPositionBottomWithDynamicContentTabItem : BunitTestContext
    {
