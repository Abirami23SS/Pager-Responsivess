...
using Syncfusion.Blazor.Tests.Tabs.Samples.HeaderPositionBottomWithDemandContent.TabItem;
using System;
using System.Linq;
...
{
    public class HeaderPositionBottomWithDemandContentTabItem : BunitTestContext
    {
