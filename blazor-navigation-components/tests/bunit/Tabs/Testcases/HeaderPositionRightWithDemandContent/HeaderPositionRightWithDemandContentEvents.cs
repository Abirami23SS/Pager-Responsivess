...
using Syncfusion.Blazor.Tests.Tabs.Samples.HeaderPositionRightWithDemandContent.Events;
using System.Threading.Tasks;
using Xunit;

namespace Syncfusion.Blazor.Tests.Tabs
{
    public class HeaderPositionRightWithDemandContentEvents : BunitTestContext
    {
