...
using Syncfusion.Blazor.Tests.Tabs.Samples.HeaderPositionRightWithDemandContent.PublicMethods;
using System.Threading.Tasks;
using Xunit;

namespace Syncfusion.Blazor.Tests.Tabs
{
    public class HeaderPositionRightWithDemandContentPublicMethods : BunitTestContext
    {
