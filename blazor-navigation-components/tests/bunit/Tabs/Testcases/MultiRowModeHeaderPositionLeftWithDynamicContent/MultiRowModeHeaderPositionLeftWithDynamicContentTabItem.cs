...
using Syncfusion.Blazor.Tests.Tabs.Samples.MultiRowModeHeaderPositionLeftWithDynamicContent.TabItem;
using System;
using System.Linq;
...
{
    public class MultiRowModeHeaderPositionLeftWithDynamicContentTabItem : BunitTestContext
    {
        ...
        public async Task ForeachLoop()
        {
            ...
            Assert.True(tab.Find("." + HelperCls.Tab).LastElementChild.ClassList.Contains(HelperCls.Content));
            Assert.True(tab.Find("." + HelperCls.Content).FirstElementChild.ClassList.Contains(HelperCls.Active));
            Assert.Equal("The Model-View-Controller (MVC) architectural pattern separates an application into three main components: the model, the view, and the controller. The ASP.NET MVC framework provides an alternative to the ASP.NET Web Forms pattern for creating Web applications. The ASP.NET MVC framework is a lightweight, highly testable presentation framework that (as with Web Forms-based applications) is integrated with existing ASP.NET features, such as master pages and membership-based authentication.", tab.Find("." + HelperCls.Active).GetElementsByTagName("div").First().InnerHtml);
        }
