...
using Syncfusion.Blazor.Tests.Tabs.Samples.HeaderPositionLeftWithDynamicContent.TabItem;
using System;
using System.Linq;
...
{
    public class HeaderPositionLeftWithDynamicContentTabItem : BunitTestContext
    {
