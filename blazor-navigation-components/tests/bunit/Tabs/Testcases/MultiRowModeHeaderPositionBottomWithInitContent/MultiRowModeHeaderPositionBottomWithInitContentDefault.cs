...
using Syncfusion.Blazor.Tests.Tabs.Samples.MultiRowModeHeaderPositionBottomWithInitContent.Default;
using System;
using System.Linq;
...
{
    public class MultiRowModeHeaderPositionBottomWithInitContentDefault : BunitTestContext
    {
        ...
        {
            var tab = RenderComponent<SfTab>(options => options.Add(content => content.OverflowMode, Syncfusion.Blazor.Navigations.OverflowMode.MultiRow).Add(content => content.HeaderPlacement, HeaderPosition.Bottom).Add(content => content.LoadOn, ContentLoad.Init));
        ...
        {
            var tab = RenderComponent<SfTab>(options => options.Add(content => content.OverflowMode, Syncfusion.Blazor.Navigations.OverflowMode.MultiRow).Add(content => content.HeaderPlacement, HeaderPosition.Bottom).Add(p => p.Height, "260px").Add(content => content.LoadOn, ContentLoad.Init));
            await Task.Delay(100);
        ...
        {
            var tab = RenderComponent<SfTab>(options => options.Add(content => content.OverflowMode, Syncfusion.Blazor.Navigations.OverflowMode.MultiRow).Add(content => content.HeaderPlacement, HeaderPosition.Bottom).Add(p => p.Width, "600px").Add(content => content.LoadOn, ContentLoad.Init));
            await Task.Delay(100);
            var tabEle = tab.Find("." + HelperCls.Tab);
            Assert.NotNull(tabEle);
