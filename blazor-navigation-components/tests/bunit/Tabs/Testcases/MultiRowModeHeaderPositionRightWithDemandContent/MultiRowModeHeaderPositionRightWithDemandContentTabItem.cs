...
using Syncfusion.Blazor.Tests.Tabs.Samples.MultiRowModeHeaderPositionRightWithDemandContent.TabItem;
using System;
using System.Linq;
...
{
    public class MultiRowModeHeaderPositionRightWithDemandContentTabItem : BunitTestContext
    {
