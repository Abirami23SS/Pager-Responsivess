...
using Syncfusion.Blazor.Tests.Tabs.Samples.HeaderPositionTopWithDynamicContent.TabItem;
using System;
using System.Linq;
...
{
    public class HeaderPositionTopWithDynamicContentTabItem : BunitTestContext
    {
