...
{
    public class ContentRenderSingleExpandModeAnimation : BunitTestContext
    {
        ...
        {
            var accordion = RenderComponent<SfAccordion>(options => options.Add(mode => mode.ExpandMode, ExpandMode.Single).Add(content => content.LoadOnDemand, false).AddChildContent<AccordionAnimationSettings>(p => p.AddChildContent<AccordionAnimationCollapse>()));
        ...
        {
            var accordion = RenderComponent<SfAccordion>(options => options.Add(mode => mode.ExpandMode, ExpandMode.Single).Add(content => content.LoadOnDemand, false).AddChildContent<AccordionAnimationSettings>(p => p.AddChildContent<AccordionAnimationExpand>()));
