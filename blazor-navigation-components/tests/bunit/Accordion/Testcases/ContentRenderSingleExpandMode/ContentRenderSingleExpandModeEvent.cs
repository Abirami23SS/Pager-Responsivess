...
{
    public class ContentRenderSingleExpandModeEvent : BunitTestContext
    {
        ...
        public void EventHandling()
        {
            ...
            var accordion = RenderComponent<SfAccordion>(options => options.Add(mode => mode.ExpandMode, ExpandMode.Single).Add(content => content.LoadOnDemand, false).AddChildContent<AccordionEvents>(events => events.Add(e => e.Created, (object args) => {
                    createdEventcount++;
        ...
        {
            var accordion = RenderComponent<SfAccordion>(options => options.Add(mode => mode.ExpandMode, ExpandMode.Single).Add(content => content.LoadOnDemand, false).AddChildContent<AccordionEvents>(events => events.Add(e => e.Clicked, (AccordionClickArgs args) => {
        ...
        {
            var accordion = RenderComponent<SfAccordion>(options => options.Add(mode => mode.ExpandMode, ExpandMode.Single).Add(content => content.LoadOnDemand, false).AddChildContent<AccordionEvents>(events => events.Add(e => e.Expanding, (ExpandEventArgs args) => {
        ...
        {
            var accordion = RenderComponent<SfAccordion>(options => options.Add(mode => mode.ExpandMode, ExpandMode.Single).Add(content => content.LoadOnDemand, false).AddChildContent<AccordionEvents>(events => events.Add(e => e.Expanded, (ExpandedEventArgs args) => {
        ...
        {
            var accordion = RenderComponent<SfAccordion>(options => options.Add(mode => mode.ExpandMode, ExpandMode.Single).Add(content => content.LoadOnDemand, false).AddChildContent<AccordionEvents>(events => events.Add(e => e.Collapsing, (CollapseEventArgs args) => {
        ...
        {
            var accordion = RenderComponent<SfAccordion>(options => options.Add(mode => mode.ExpandMode, ExpandMode.Single).Add(content => content.LoadOnDemand, false).AddChildContent<AccordionEvents>(events => events.Add(e => e.Collapsed, (CollapsedEventArgs args) => {
