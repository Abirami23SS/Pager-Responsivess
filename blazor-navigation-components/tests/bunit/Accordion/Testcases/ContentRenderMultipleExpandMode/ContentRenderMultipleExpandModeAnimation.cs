...
{
    public class ContentRenderMultipleExpandModeAnimation : BunitTestContext
    {
        ...
        {
            var accordion = RenderComponent<SfAccordion>(options => options.Add(content => content.LoadOnDemand, false).AddChildContent<AccordionAnimationSettings>(p => p.AddChildContent<AccordionAnimationCollapse>()));
        ...
        {
            var accordion = RenderComponent<SfAccordion>(options => options.Add(content => content.LoadOnDemand, false).AddChildContent<AccordionAnimationSettings>(p => p.AddChildContent<AccordionAnimationExpand>()));
