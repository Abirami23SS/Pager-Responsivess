...
using Syncfusion.Blazor.Tests.Accordion.Samples.SingleExpanMode.Default;
using System;
using System.Linq;
...
{
    public class SingleExpandModeDefault : BunitTestContext
    {
        ...
        {
            var cut = RenderComponent<SfAccordion>(options => options.Add(mode => mode.ExpandMode, ExpandMode.Single));
        ...
        {
            var accordion = RenderComponent<SfAccordion>(options => options.Add(mode => mode.ExpandMode, ExpandMode.Single).Add(p => p.EnableRtl, true));
        ...
        {
            var accordion = RenderComponent<SfAccordion>(options => options.Add(mode => mode.ExpandMode, ExpandMode.Single).Add(p => p.EnableRtl, false));
            var rootEle = accordion.Find("." + HelperCls.Accordion);
