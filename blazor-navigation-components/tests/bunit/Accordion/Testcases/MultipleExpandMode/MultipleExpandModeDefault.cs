...
using Syncfusion.Blazor.Tests.Accordion.Samples.MultipleExpandMode.Default;
using System;
using System.Linq;
...
{
    public class MultipleExpandModeDefault : BunitTestContext
    {
        ...
        public void DefaultValueAccordion()
        {
            ...
            Assert.True(cut.Instance.LoadOnDemand);
        ...
        public void Width()
        {
            ...
            Assert.Contains("600", accordionWidth);
        }
        ...
        {
            var accordion = RenderComponent<SfAccordion>(options => options.Add(p => p.EnableRtl, true));
        ...
        {
            var accordion = RenderComponent<SfAccordion>(options => options.Add(p => p.EnableRtl, false));
            var rootEle = accordion.Find("." + HelperCls.Accordion);
