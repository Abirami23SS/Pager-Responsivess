...
{
    public class MultipleExpandModeAnimation : BunitTestContext
    {
        ...
        {
            var accordion = RenderComponent<SfAccordion>(options => options.AddChildContent<AccordionAnimationSettings>(p => p.AddChildContent<AccordionAnimationCollapse>()));
        ...
        {
            var accordion = RenderComponent<SfAccordion>(options => options.AddChildContent<AccordionAnimationSettings>(p => p.AddChildContent<AccordionAnimationExpand>()));
