...
using Syncfusion.Blazor.Tests.Toolbar.Samples.PopupMode.Default;
using System;
using System.Linq;
...
{
    public class PopupModeDefault : BunitTestContext
    {
        ...
        {
            var toolbar = RenderComponent<SfToolbar>(options => options.Add(mode => mode.OverflowMode, Syncfusion.Blazor.Navigations.OverflowMode.Popup));
            ...
            Assert.Equal(Syncfusion.Blazor.Navigations.OverflowMode.Popup, toolbar.Instance.OverflowMode);
        ...
        public void Height()
        {
            var toolbar = RenderComponent<SfToolbar>(options => options.Add(p => p.Height, "260px").Add(mode => mode.OverflowMode, Syncfusion.Blazor.Navigations.OverflowMode.Popup));
        ...
        public void Width()
        {
            var toolbar = RenderComponent<SfToolbar>(options => options.Add(p => p.Width, "600px").Add(mode => mode.OverflowMode, Syncfusion.Blazor.Navigations.OverflowMode.Popup));
            var toolbarEle = toolbar.Find("." + HelperCls.Toolbar);
            Assert.NotNull(toolbarEle);
