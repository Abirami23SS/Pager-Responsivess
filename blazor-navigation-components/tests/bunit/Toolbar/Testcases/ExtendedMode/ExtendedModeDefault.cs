...
using Syncfusion.Blazor.Tests.Toolbar.Samples.ExtendedMode.Default;
using System;
using System.Linq;
...
{
    public class ExtendedModeDefault : BunitTestContext
    {
        ...
        {
            var toolbar = RenderComponent<SfToolbar>(options => options.Add(mode => mode.OverflowMode, Syncfusion.Blazor.Navigations.OverflowMode.Extended));
            ...
            Assert.Equal(Syncfusion.Blazor.Navigations.OverflowMode.Extended, toolbar.Instance.OverflowMode);
        ...
        public async Task CssClass()
        {
            ...
            var toolbarComp = RenderComponent<SfToolbar>(options => options.Add(p => p.CssClass, "e-custom-class").Add(mode => mode.OverflowMode, Syncfusion.Blazor.Navigations.OverflowMode.Extended));
        ...
        public void Height()
        {
            var toolbar = RenderComponent<SfToolbar>(options => options.Add(p => p.Height, "260px").Add(mode => mode.OverflowMode, Syncfusion.Blazor.Navigations.OverflowMode.Extended));
        ...
        public void Width()
        {
            var toolbar = RenderComponent<SfToolbar>(options => options.Add(p => p.Width, "600px").Add(mode => mode.OverflowMode, Syncfusion.Blazor.Navigations.OverflowMode.Extended));
            var toolbarEle = toolbar.Find("." + HelperCls.Toolbar);
            Assert.NotNull(toolbarEle);
        ...
        public async Task EnableRTL()
        {
            ...
            var toolbarComp = RenderComponent<SfToolbar>(options => options.Add(p => p.EnableRtl, true).Add(mode => mode.OverflowMode, Syncfusion.Blazor.Navigations.OverflowMode.Extended));
            var toolbarEle = toolbarComp.Find("." + HelperCls.Toolbar);
            Assert.NotNull(toolbarEle);
