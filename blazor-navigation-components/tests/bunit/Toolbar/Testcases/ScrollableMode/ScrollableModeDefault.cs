...
using Syncfusion.Blazor.Tests.Toolbar.Samples.ScrollableMode.Default;
using System;
using System.Linq;
...
{
    public class ScrollableModeDefault : BunitTestContext
    {
        ...
        {
            var toolbar = RenderComponent<SfToolbar>();
            ...
            Assert.Equal(Syncfusion.Blazor.Navigations.OverflowMode.Scrollable, toolbar.Instance.OverflowMode);
        ...
        public void Height()
        {
            var toolbar = RenderComponent<SfToolbar>(options => options.Add(p => p.Height, "260px"));
        ...
        public void Width()
        {
            var toolbar = RenderComponent<SfToolbar>(options => options.Add(p => p.Width, "600px"));
            var toolbarEle = toolbar.Find("." + HelperCls.Toolbar);
            Assert.NotNull(toolbarEle);
