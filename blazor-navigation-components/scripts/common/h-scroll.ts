import { Touch, ScrollEventArgs, TouchEventArgs, Component, EventHandler, selectAll, getUniqueID, ComponentModel } from '@syncfusion/ej2-base';
...
interface HScrollModel extends ComponentModel{
    scrollStep?: number;
}
