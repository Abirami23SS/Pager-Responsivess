...
window.sfBlazor.Carousel = (function () {
    ...
    var SfCarousel = /** @class */ (function () {
        ...
        SfCarousel.prototype.initializeTouch = function () {
            if ((!(this.swipeMode.toString() === '-4' || this.swipeMode.toString() === '-2'))) {
                this.touchInstance = new sf.base.Touch(this.itemsContainer, {
        ...
        SfCarousel.prototype.removeTouch = function () {
            if (this.touchInstance) {
                this.touchInstance.destroy();
                this.touchInstance = null;
                sf.base.EventHandler.remove(this.element, 'transitionend', this.onTransitionEnd);
            }
        };
        SfCarousel.prototype.updateTouch = function (enableTouchSwipe, swipeMode) {
            this.swipeMode = swipeMode;
        ...
        SfCarousel.prototype.swipeHandler = function (e) {
            ...
            var eventName = e.startEvents ? e.startEvents.toString() : null;
        ...
        SfCarousel.prototype.changeActiveClass = function (direction, index) {
            ...
            if (!sf.base.isNullOrUndefined(index)) {
                var currentPanel_1 = this.element.querySelectorAll('.' + CLS_ITEM + ':not(.' + 'e-clone' + ')')[parseInt(index.toString(), 10)];
        ...
        SfCarousel.prototype.changeSlide = function (direction) {
        ...
        SfCarousel.prototype.destroy = function () {
            this.removeTouch();
    ...
    var BlazorCarousel = {
        initialize: function (dataId, element, swipeMode, dotnetRef) {
            // eslint-disable-next-line @typescript-eslint/no-unused-vars
            new SfCarousel(dataId, element, swipeMode, dotnetRef);
        },
        swipeHandler: function (dataId, direction, index) {
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
        ...
        updateTouch: function (dataId, enableTouchSwipe, swipeMode) {
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            var instance = window.sfBlazor.getCompInstance(dataId);
            if (instance && instance.element) {
