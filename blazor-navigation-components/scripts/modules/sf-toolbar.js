...
window.sfBlazor.Toolbar = (function () {
    ...
    var SfToolbar = /** @class */ (function () {
        ...
        SfToolbar.prototype.destroyMode = function () {
            if (this.scrollModule) {
                this.scrollPosition = this.scrollModule
        ...
        SfToolbar.prototype.clickHandler = function (e) {
            ...
            if (!sf.base.isNullOrUndefined(clst) && !clst.classList.contains(CLS_DISABLE) && !sf.base.isNullOrUndefined(clst.firstElementChild)
        ...
        SfToolbar.prototype.initScroll = function (element, innerItems) {
            if (!this.scrollModule && this.checkOverflow(element, innerItems[0])) {
                ...
                var scrollEle = this.scrollModule.element.querySelector('.' + 'e-hscroll-bar' + ', .' + 'e-vscroll-bar');
                if (scrollEle) {
        ...
        SfToolbar.prototype.itemWidthCal = function (items) {
            ...
            [].slice.call(sf.base.selectAll('.' + CLS_ITEM, items)).forEach(function (el) {
                if (sf.base.isVisible(el) && !el.classList.contains(CLS_SPACER)) {
        ...
        SfToolbar.prototype.createPopupEle = function (ele, innerEle) {
            ...
            sf.base.setStyleAttribute(this.element, { direction: 'initial', textAlign: 'left' });
        ...
        SfToolbar.prototype.checkPriority = function (ele, inEle, eleWidth, pre) {
            ...
            for (var i = len - 1; i >= 0; i--) {
                ...
                if (checkClass(inEle[parseInt(i.toString(), 10)], [CLS_POPPRI]) && popPriority) {
                    ...
                    if (this.options.isVertical) {
                        sf.base.setStyleAttribute(inEle[parseInt(i.toString(), 10)], { display: 'none', minHeight: eleWid_1 + 'px' });
                    }
                    else {
                        sf.base.setStyleAttribute(inEle[parseInt(i.toString(), 10)], { display: 'none', minWidth: eleWid_1 + 'px' });
                    }
                    itemPopCount++;
                }
                if (this.options.isVertical) {
                ...
                var checkWidth = ele.querySelector('.' + CLS_SPACER) ?
        ...
        SfToolbar.prototype.tbarPriRef = function (inEle, indx, sepPri, el, des, elWid, wid, ig) {
            ...
            if (sf.base.selectAll(query, inEle).length === 0) {
                ...
                if ((!sf.base.isNullOrUndefined(eleSep) && checkClass(eleSep, CLS_SEPARATOR) &&
                    checkClass(eleSep, CLS_SPACER) && !sf.base.isVisible(eleSep)) || ignoreCheck) {
                    var sepDisplay = 'none';
        ...
        SfToolbar.prototype.checkPopupRefresh = function (root, popEle) {
            ...
            var tbarItems = root.querySelector('.' + CLS_ITEMS);
            var tbarItemsWid = root.querySelector('.' + CLS_SPACER) ? this.itemWidthCal(tbarItems) : tbarItems.offsetWidth;
        ...
        SfToolbar.prototype.popupEleRefresh = function (width, popupEle, destroy) {
            ...
            var _loop_1 = function (el) {
                ...
                if (elWidth < width || destroy) {
                    ...
                    if (this_1.tbarAlign) {
                        var pos = this_1.options.items[parseInt(index.toString(), 10)].align;
        ...
        SfToolbar.prototype.tbarItemAlign = function (item, itemEle, pos) {
            ...
            var alignDiv = [];
            alignDiv.push(sf.base.createElement('div', { className: CLS_TBARLEFT, attrs: { role: 'group' } }));
            alignDiv.push(sf.base.createElement('div', { className: CLS_TBARCENTER, attrs: { role: 'group' } }));
            alignDiv.push(sf.base.createElement('div', { className: CLS_TBARRIGHT, attrs: { role: 'group' } }));
        ...
        SfToolbar.prototype.renderItems = function () {
            ...
            if (ele && !sf.base.isNullOrUndefined(items) && items.length > 0) {
                var itemEleDom = ele.querySelector('.' + CLS_ITEMS);
        ...
        SfToolbar.prototype.setAttr = function (attr, element) {
            ...
            for (var i = 0; i < key.length; i++) {
                ...
                if (keyVal === 'class') {
                    sf.base.addClass([element], attr["".concat(keyVal)]);
                }
                else {
                    element.setAttribute(keyVal, attr["".concat(keyVal)]);
                }
            }
        };
        ...
        SfToolbar.prototype.getItemsWidth = function (element) {
            var width = Array.from(element.children).reduce(function (total, child) { return total +
                child.offsetWidth; }, 0);
            return width;
        };
        return SfToolbar;
    ...
    var Toolbar = {
        ...
        hidePopup: function (dataId, targetIndex) {
        ...
        setWidth: function (dataId, width) {
            var instance = window.sfBlazor.getCompInstance(dataId);
            if (!sf.base.isNullOrUndefined(instance) && !sf.base.isNullOrUndefined(instance.element)) {
                instance.options.width = width;
                instance.extendedOpen();
                var wid = instance.element.offsetWidth;
                sf.base.setStyleAttribute(instance.element, { 'width': sf.base.formatUnit(width) });
        ...
        setHeight: function (dataId, height) {
            var instance = window.sfBlazor.getCompInstance(dataId);
            if (!sf.base.isNullOrUndefined(instance) && !sf.base.isNullOrUndefined(instance.element)) {
                instance.options.height = height;
                instance.extendedOpen();
                sf.base.setStyleAttribute(instance.element, { 'height': sf.base.formatUnit(height) });
            }
        },
        setOverflowMode: function (dataId, overflowMode) {
            var instance = window.sfBlazor.getCompInstance(dataId);
            if (!sf.base.isNullOrUndefined(instance) && !sf.base.isNullOrUndefined(instance.element)) {
        ...
        setEnableRTL: function (dataId, enableRtl) {
            var instance = window.sfBlazor.getCompInstance(dataId);
            if (!sf.base.isNullOrUndefined(instance) && !sf.base.isNullOrUndefined(instance.element)) {
        ...
        setScrollStep: function (dataId, scrollStep) {
            var instance = window.sfBlazor.getCompInstance(dataId);
            if (!sf.base.isNullOrUndefined(instance) && !sf.base.isNullOrUndefined(instance.element)) {
        ...
        setEnableCollision: function (dataId, enableCollision) {
            var instance = window.sfBlazor.getCompInstance(dataId);
            if (!sf.base.isNullOrUndefined(instance) && !sf.base.isNullOrUndefined(instance.element)) {
        ...
        setAllowKeyboard: function (dataId, allowKeyboard) {
            var instance = window.sfBlazor.getCompInstance(dataId);
            if (!sf.base.isNullOrUndefined(instance) && !sf.base.isNullOrUndefined(instance.element)) {
        ...
        serverItemsRerender: function (dataId, items, firstRender) {
            var instance = window.sfBlazor.getCompInstance(dataId);
            if (!sf.base.isNullOrUndefined(instance) && !sf.base.isNullOrUndefined(instance.element)) {
                var isSpacer = instance.element.querySelector('.' + CLS_ITEMS + ' ' + '.' + CLS_SPACER);
                if (!sf.base.isNullOrUndefined(isSpacer) && !instance.element.classList.contains('e-spacer-toolbar')) {
        ...
        hideItem: function (dataId, items, eleIndex) {
            if (sf.base.isNullOrUndefined(eleIndex)) {
                return;
            }
            var instance = window.sfBlazor.getCompInstance(dataId);
            if (!sf.base.isNullOrUndefined(instance) && !sf.base.isNullOrUndefined(instance.element)) {
        ...
        refreshOverflow: function (dataId) {
            var instance = window.sfBlazor.getCompInstance(dataId);
            if (!sf.base.isNullOrUndefined(instance) && !sf.base.isNullOrUndefined(instance.element)) {
                instance.refreshOverflow();
            }
        ...
        refresh: function (dataId, options) {
            var instance = window.sfBlazor.getCompInstance(dataId);
            if (options.scrollStep === 0) {
                options.scrollStep = null;
            }
