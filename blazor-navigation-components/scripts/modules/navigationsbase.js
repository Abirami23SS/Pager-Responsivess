...
var navigationsbase = (function (exports) {
    ...
    var HScroll = /** @class */ (function (_super) {
        ...
        HScroll.prototype.preRender = function () {
            ...
            if (this.enableRtl) {
                element.classList.add(CLS_RTL$1);
            }
        };
        ...
        HScroll.prototype.destroy = function () {
            ...
            ele.classList.remove(CLS_RTL$1);
            var nav = sf.base.selectAll('.e-' + ele.id + '_nav.' + CLS_HSCROLLNAV, ele);
            var overlay = sf.base.selectAll('.' + CLS_OVERLAY$1, ele);
        ...
        HScroll.prototype.disable = function (value) {
            var navEles = sf.base.selectAll('.e-scroll-nav:not(.' + CLS_DISABLE$1 + ')', this.element);
            if (value) {
        ...
        HScroll.prototype.createNavIcon = function (element) {
            ...
            var navEle = this.createElement('div', { className: clsLeft + ' ' + CLS_DISABLE$1, attrs: leftAttributes });
        ...
        HScroll.prototype.eleScrolling = function (scrollDis, trgt, isContinuous) {
            ...
            if (this.contains(rootEle, CLS_RTL$1) && this.browserCheck) {
                scrollDis = -scrollDis;
            }
            if ((!this.contains(rootEle, CLS_RTL$1) || this.browserCheck) || this.ieCheck) {
        ...
        HScroll.prototype.frameScrollRequest = function (scrollVal, action, isContinuous) {
            ...
            var animate = function () {
                var scrollValue;
                var scrollStep;
                if (_this.contains(_this.element, CLS_RTL$1) && _this.browserCheck) {
        ...
        HScroll.prototype.touchHandler = function (e) {
            ...
            if ((this.ieCheck) && this.contains(this.element, CLS_RTL$1)) {
                distance = -distance;
            }
        ...
        HScroll.prototype.arrowDisabling = function (addDisable, removeDisable) {
            if (this.isDevice) {
                ...
                addDisable.classList.add(CLS_DISABLE$1);
                addDisable.setAttribute('aria-disabled', 'true');
                addDisable.removeAttribute('tabindex');
                removeDisable.classList.remove(CLS_DISABLE$1);
        ...
        HScroll.prototype.scrollHandler = function (e) {
            ...
            if (scrollLeft === 0) {
                ...
                var disEle = this.element.querySelector('.' + CLS_HSCROLLNAV + '.' + CLS_DISABLE$1);
                if (disEle) {
    ...
    var VScroll = /** @class */ (function (_super) {
        ...
        VScroll.prototype.destroy = function () {
            var el = this.element;
            el.style.display = '';
            sf.base.removeClass([this.element], [CLS_ROOT, CLS_DEVICE, CLS_RTL]);
            var navs = sf.base.selectAll('.e-' + el.id + '_nav.' + CLS_VSCROLLNAV, el);
            var overlays = sf.base.selectAll('.' + CLS_OVERLAY, el);
        ...
        VScroll.prototype.disable = function (value) {
            var navEle = sf.base.selectAll('.e-scroll-nav:not(.' + CLS_DISABLE + ')', this.element);
            if (value) {
        ...
        VScroll.prototype.createOverlayElement = function (element) {
            var id = element.id.concat('_nav');
            var downOverlayEle = sf.base.createElement('div', { className: CLS_OVERLAY + ' ' + CLS_DOWNOVERLAY });
            var clsDown = 'e-' + element.id.concat('_nav ' + CLS_VSCROLLNAV + ' ' + CLS_VSCROLLNAVDOWN);
            var downEle = sf.base.createElement('div', { id: id.concat('down'), className: clsDown });
            var navItem = sf.base.createElement('div', { className: CLS_NAVDOWNARROW + ' ' + CLS_NAVARROW + ' e-icons' });
            downEle.appendChild(navItem);
            var upEle = sf.base.createElement('div', { className: CLS_OVERLAY + ' ' + CLS_UPOVERLAY });
            if (this.ieCheck) {
        ...
        VScroll.prototype.createNavIcon = function (element) {
            ...
            var navElement = sf.base.createElement('div', { id: id.concat('_up'), className: clsUp + ' ' + CLS_DISABLE });
            navElement.setAttribute('aria-disabled', 'true');
            var navUpItem = sf.base.createElement('div', { className: CLS_NAVUPARROW + ' ' + CLS_NAVARROW + ' e-icons' });
