...
window.sfBlazor.Tab = (function () {
    ...
    var SfTab = /** @class */ (function () {
        ...
        SfTab.prototype.render = function () {
            ...
            sf.base.attributes(this.element, { 'aria-disabled': 'false' });
        ...
        SfTab.prototype.headerReady = function () {
            ...
            if (sf.base.selectAll('.' + CLS_TB_ITEM, this.element).length > 0 && !sf.base.isNullOrUndefined(this.tbItems)) {
        ...
        SfTab.prototype.bindSwipeEvents = function () {
        ...
        SfTab.prototype.triggerAnimation = function (id, value) {
            ...
            if (this.initRender || value === false || sf.base.isNullOrUndefined(this.options.animation) || (this.options.animation && Object.keys(this.options.animation).length === 0)) {
        ...
        SfTab.prototype.findEle = function (items, key) {
            ...
            for (var i = 0; i < items.length; i++) {
                if (items[parseInt(i.toString(), 10)].id === key) {
                    ele = items[parseInt(i.toString(), 10)];
                    break;
                }
            }
            return ele;
        ...
        SfTab.prototype.focusItem = function (preventScroll, preventFocus) {
            ...
            if (!sf.base.isNullOrUndefined(curActItem)) {
                if (!preventFocus) {
                    curActItem.firstElementChild.focus({ preventScroll: preventScroll });
                }
            }
        };
        ...
        SfTab.prototype.setActiveBorder = function () {
            ...
            if (sf.base.isNullOrUndefined(trg) || sf.base.isNullOrUndefined(trgHdrEle)) {
                return;
            }
            ...
            if (this.isVertical()) {
                ...
                if (this.options.overflowMode === 'MultiRow') {
                    ...
                    sf.base.setStyleAttribute(bar, { 'top': top_1 + 'px', 'height': '' });
                }
                else {
        ...
        SfTab.prototype.setActive = function (value, preventFocus) {
            ...
            if (!sf.base.isNullOrUndefined(trg) && trg.classList.contains(CLS_DISABLE)) {
                return;
            }
            this.options.selectedItem = value;
            if (!sf.base.isNullOrUndefined(trg) && trg.classList.contains(CLS_HIDDEN)) {
                trg.classList.remove(CLS_HIDDEN);
                if (!sf.base.isNullOrUndefined(trg.nextElementSibling)) {
            ...
            sf.base.attributes(trg.firstElementChild, { 'aria-controls': CLS_CONTENT + this.tabId + '_' + value });
            var id = CLS_ITEM + this.tabId + '_' + this.options.selectedItem;
        ...
        SfTab.prototype.itemDragStart = function (e) {
            ...
            this.element.querySelector('.e-toolbar');
        ...
        SfTab.prototype.swipeHandler = function (e) {
            if ((e.velocity < 3 && sf.base.isNullOrUndefined(e.originalEvent.changedTouches)) || ((this.options.swipeMode === 1 && (e.originalEvent.type === 'mouseup' || e.originalEvent.type === 'mouseleave')) || (this.options.swipeMode === 2 && e.originalEvent.type === 'touchend'))) {
                return;
            }
            if (this.isNested) {
        ...
        SfTab.prototype.refreshItemVisibility = function (target) {
            ...
            if (!this.isVertical() && !sf.base.isNullOrUndefined(scrCnt)) {
                ...
                var eleEnd = this.options.enableRtl ? -(scrCnt.scrollWidth - target.offsetLeft) :
        ...
        SfTab.prototype.applyTablistRole = function () {
            var header = this.getTabHeader();
            if (!header) {
                return;
            }
            var scrollContainer = header.querySelector('.' + this.scrCntClass);
            var itemsContainer = header.querySelector('.' + CLS_TB_ITEMS);
            if (scrollContainer) {
        ...
        SfTab.prototype.enableTab = function (index, value) {
            var tbItems = sf.base.selectAll('.' + CLS_TB_ITEM, this.element)[parseInt(index.toString(), 10)];
        ...
        SfTab.prototype.hideTab = function (index, value) {
            ...
            var items;
            var item = sf.base.select('.' + CLS_TB_ITEM + '[data-index="' + index + '"]', this.element);
            if (sf.base.isNullOrUndefined(item)) {
                return;
            }
            this.bdrLine.classList.add(CLS_HIDDEN);
                ...
                if (items.length !== 0 && item.classList.contains(CLS_ACTIVE)) {
                    ...
                    if (index !== 0) {
                        for (var i = index - 1; i >= 0; i--) {
                            if (!this.tbItem[parseInt(i.toString(), 10)].classList.contains(CLS_HIDDEN)) {
                                var activeIndex = Array.from(items).indexOf(this.tbItem[i]);
                                ...
                                for (var k = index + 1; k < this.tbItem.length; k++) {
                                    if (!this.tbItem[parseInt(k.toString(), 10)].classList.contains(CLS_HIDDEN)) {
                                        var activeIndex = Array.from(items).indexOf(this.tbItem[k]);
                                        this.select(activeIndex);
                                        break;
                                    }
                                }
        ...
        SfTab.prototype.select = function (args, isInteracted) {
            ...
            var visibleTabs = [].slice.call(this.tbItem).filter(function (item) { return !item.classList.contains('e-hidden'); });
            var trg = visibleTabs[args];
            if (!sf.base.isNullOrUndefined(trg) && trg.classList.contains(CLS_DISABLE)) {
                return;
            }
    ...
    var Tab = {
        ...
        headerReady: function (dataId, isCreatedEvent) {
            var instance = window.sfBlazor.getCompInstance(dataId);
            if (!sf.base.isNullOrUndefined(instance) && !sf.base.isNullOrUndefined(instance.element)) {
                instance.headerReady();
            }
        },
        contentReady: function (dataId, selectingIndex) {
            var instance = window.sfBlazor.getCompInstance(dataId);
            if (!sf.base.isNullOrUndefined(instance) && !sf.base.isNullOrUndefined(instance.element)) {
                var args = { isPopupElement: false };
        ...
        selectingContent: function (dataId, selectingIndex) {
            var instance = window.sfBlazor.getCompInstance(dataId);
            if (!sf.base.isNullOrUndefined(instance) && !sf.base.isNullOrUndefined(instance.element)) {
        ...
        // eslint-disable-next-line max-len
        serverItemsChanged: function (dataId, selectedItem, animation, isVerticalIcon, preventFocus) {
            var instance = window.sfBlazor.getCompInstance(dataId);
            if (!sf.base.isNullOrUndefined(instance) && !sf.base.isNullOrUndefined(instance.element)) {
        ...
        enableTab: function (dataId, index, value) {
            var instance = window.sfBlazor.getCompInstance(dataId);
            if (!sf.base.isNullOrUndefined(instance) && !sf.base.isNullOrUndefined(instance.element)) {
                instance.enableTab(index, value);
            }
        },
        hideTab: function (dataId, index, value) {
            var instance = window.sfBlazor.getCompInstance(dataId);
            if (!sf.base.isNullOrUndefined(instance) && !sf.base.isNullOrUndefined(instance.element)) {
                instance.hideTab(index, value);
            }
        },
        select: function (dataId, index) {
            var instance = window.sfBlazor.getCompInstance(dataId);
            if (!sf.base.isNullOrUndefined(instance) && !sf.base.isNullOrUndefined(instance.element)) {
                instance.select(index);
            }
        },
        disable: function (dataId, value) {
            var instance = window.sfBlazor.getCompInstance(dataId);
            if (!sf.base.isNullOrUndefined(instance) && !sf.base.isNullOrUndefined(instance.element)) {
                instance.disable(value);
            }
        },
        setCssClass: function (dataId, cssClass) {
            var instance = window.sfBlazor.getCompInstance(dataId);
            if (!sf.base.isNullOrUndefined(instance) && !sf.base.isNullOrUndefined(instance.element)) {
        ...
        showCloseButton: function (dataId, showCloseButton) {
            var instance = window.sfBlazor.getCompInstance(dataId);
            if (!sf.base.isNullOrUndefined(instance) && !sf.base.isNullOrUndefined(instance.element)) {
        ...
        // eslint-disable-next-line max-len
        headerPlacement: function (dataId, headerPlacement, selectedItem, toolbarDataId, toolbarCssClass, isVertical, isOrientationChange) {
            var instance = window.sfBlazor.getCompInstance(dataId);
            if (!sf.base.isNullOrUndefined(instance) && !sf.base.isNullOrUndefined(instance.element)) {
        ...
        enableRtl: function (dataId, enableRtl) {
            var instance = window.sfBlazor.getCompInstance(dataId);
            if (!sf.base.isNullOrUndefined(instance) && !sf.base.isNullOrUndefined(instance.element)) {
        ...
        overflowMode: function (dataId, overflowMode) {
            var instance = window.sfBlazor.getCompInstance(dataId);
            if (!sf.base.isNullOrUndefined(instance) && !sf.base.isNullOrUndefined(instance.element)) {
        ...
        allowDragAndDrop: function (dataId, allowDragAndDrop) {
            var instance = window.sfBlazor.getCompInstance(dataId);
            if (!sf.base.isNullOrUndefined(instance) && !sf.base.isNullOrUndefined(instance.element)) {
        ...
        destroy: function (dataId, elementId, selectedItem) {
            var instance = window.sfBlazor.getCompInstance(dataId);
            if (!sf.base.isNullOrUndefined(instance) && !sf.base.isNullOrUndefined(instance.element)) {
        ...
        getTabContent: function (dataId, index) {
            var instance = window.sfBlazor.getCompInstance(dataId);
            if (!sf.base.isNullOrUndefined(instance) && !sf.base.isNullOrUndefined(instance.element)) {
        ...
        focusSelectedTab: function (dataId, preventFocus) {
            var instance = window.sfBlazor.getCompInstance(dataId);
            if (!sf.base.isNullOrUndefined(instance) && !sf.base.isNullOrUndefined(instance.element)) {
